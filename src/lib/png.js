// Define the functions used in the class as standalone functions
// Convert the class into a functional component
...
export function setPhysChunk(view, dpr = 1, options) {
  let offset = 46;
  let size = 0;
